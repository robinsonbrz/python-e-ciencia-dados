...
gur ubhfr. The Gothon stops, tries not to laugh, then busts out
laughing and can't move. While he's laughing you run up and shoot him
...
def load_room(name):
    ...
    """
    return globals().get(name)  # returns None if not found
